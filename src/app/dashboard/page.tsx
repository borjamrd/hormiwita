    ...
    <div className="flex flex-col h-screen bg-slate-50 dark:bg-slate-900 lg:max-h-[calc(100vh-64px)]">
      <main className="flex-grow container mx-auto p-4 sm:p-4 lg:p-6 flex flex-col overflow-hidden">
        <div className="mb-4 flex-shrink-0 flex items-center justify-between">
          ...
          <Dialog>
            <DialogTrigger className="h-9 px-3 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:text-accent-foreground">
              <span>Hormiwicoins💰</span>
            </DialogTrigger>
